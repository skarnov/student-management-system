<?php
    ...
    $obj_home = new Home();
    $result = $obj_home->select_faculty_by_id($_GET['teacher_id']);
    $all_teacher = $obj_home->select_all_faculty_from_db();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ?>  
                            <div class="col-xs-12">
                                <img src="<?php echo "teacher_images/" . substr($row['teacher_image'], strrpos($row['teacher_image'], '/'), strlen($row['teacher_image'])) ?>" class="img-rounded" alt="Cinque Terre" width="304" height="236"><br/><br/>
                            </div>
                            <div class="col-xs-12">
                                <?php echo $row['teacher_name']; ?>
                                <hr/>
                                <?php echo $row['teacher_description']; ?><br/><br/><br/>
                            </div>
                            <?php
                        }
                        ?>
                    ...
                    <div class="col-xs-4">
                        <h2 style="margin-left: 5%;">All Faculty</h2>
                        <?php
                        while ($row = mysql_fetch_assoc($all_teacher)) {
                            ?>
                            <div class="feature">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8" >
                                    <a href="teacher_details.php?teacher_id=<?php echo $row['teacher_id']; ?>"><p class="feature_description"><?php echo $row['teacher_name']; ?></p></a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
