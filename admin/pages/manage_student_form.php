...
$query_result=$obj_super_admin->select_all_student();
...
<br/>
<ol class="breadcrumb">
    <h1 class="box-title">Manage Student</h1>
</ol>
<div class="col-md-12">
    <div class="box">
        <div class="box-body">
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <?php
                                ...
                                {
                            ?>
                            <a class="btn btn-success" href="?status=active&id=<?php echo $row['student_id']?>">
                                <i class="icon-ok">Active</i>   
                            </a>
                                <?php } else{?>
                            <a class="btn btn-danger" href="?status=inactive&id=<?php echo $row['student_id']?>">
                                <i class="icon-remove">Inactive</i>  
                            </a>
                                <?php } ?>
                            <a class="btn btn-info" href="edit_student.php?id=<?php echo $row['student_id']?>">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="?status=delete&id=<?php echo $row['student_id']?>" class="btn btn-success">Yes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
