...
$query_result = $obj_super_admin->select_all_class();
if (isset($_GET['status'])) {
    $status = $_GET['status'];
    $id = $_GET['id'];
    if ($status == 'active') {
        $obj_super_admin->published_class($id);
    } else if ($status == 'inactive') {
        $obj_super_admin->unpublished_class($id);
    } else if ($status == 'delete') {
        $obj_super_admin->delete_class($id);
    }
}
?>
...
<br/>
<ol class="breadcrumb">
    <h1 class="box-title">Manage Class</h1>
</ol>
<div class="col-md-12">
    <div class="box">
        <div class="box-body">
                    ...
                    while ($row = mysql_fetch_assoc($query_result)) {
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="edit_class.php?id=<?php echo $row['class_id'] ?>">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="?status=delete&id=<?php echo $row['class_id'] ?>" class="btn btn-success">Yes</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
