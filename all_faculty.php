<?php
    ...
    $obj_home = new Home();
    $result = $obj_home->select_all_faculty();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    while ($row = mysql_fetch_assoc($result)) {
                        ...
                        <div class="col-xs-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active"><a href="all_faculty.php">All Faculty</a></li>
                            </ul>
                            <img src="<?php echo "teacher_images/" . substr($row['teacher_image'], strrpos($row['teacher_image'], '/'), strlen($row['teacher_image'])) ?>" class="img-rounded" alt="Cinque Terre"><br/><br/>
                        </div>
                        <div class="col-xs-12">
