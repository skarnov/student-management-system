<?php
    ...
    $obj_home = new Home();
    $result = $obj_home->select_event_by_id($_GET['event_id']);
    $all_events = $obj_home->select_all_event_from_db();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ...
                            <div class="col-xs-12">
                                ...
                                <hr/>
                                <?php echo $row['event_main']; ?><br/><br/><br/>
                            </div>
                            <?php
                        }
                        ?>
                    ...
                    <div class="col-xs-4">
                        <h2 style="margin-left: 5%;">All Events</h2>
                        <?php
