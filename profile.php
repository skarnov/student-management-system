<?php
    ...
    $result = $obj_home->select_profile($student_email, $student_password);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                while ($row = mysql_fetch_assoc($result)) {
                                    ?>
                                    <tr>
                                        <td class="center"><img src="<?php echo "student_images/" . substr($row['student_image'], strrpos($row['student_image'], '/'), strlen($row['student_image'])) ?>" style="height:300px; width:300px"></td>
                                        ...
                                        <td class="center"><?php echo $row['student_password'] ?></td>
