...
$result = $obj_super_admin->select_all_subject();
if (isset($_GET['status'])) {
    $status = $_GET['status'];
    $id = $_GET['id'];
    if ($status == 'active') {
        $obj_super_admin->published_subject($id);
    } else if ($status == 'inactive') {
        $obj_super_admin->unpublished_subject($id);
    } else if ($status == 'delete') {
        $obj_super_admin->delete_subject($id);
    }
}
?>
...
<br/>
<ol class="breadcrumb">
    <h1 class="box-title">Manage Subject</h1>
</ol>
<div class="col-md-12">
                ...
                <tbody>
                    ...
                    while ($row = mysql_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <a class="btn btn-info" href="edit_subject.php?id=<?php echo $row['subject_id'] ?>">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="?status=delete&id=<?php echo $row['subject_id'] ?>" class="btn btn-success">Yes</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
