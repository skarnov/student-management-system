<?php
    ...
    $obj_home = new Home();
    $result = $obj_home->select_all_news();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        while ($row = mysql_fetch_assoc($result)) {
                            ...
                            <div class="col-xs-12">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active"><a href="all_news.php">All News</a></li>
                                </ul>
                                <img src="<?php echo "news_images/" . substr($row['news_image'], strrpos($row['news_image'], '/'), strlen($row['news_image'])) ?>" class="img-rounded" alt="Cinque Terre"><br/><br/>
                            </div>
                            <div class="col-xs-12">
